...
public class ShopGUI {
    ...
    public static void openGUI(Player p) {
        ...
        MenuItem basic = new MenuItem(new ItemBuilder(new ItemStack(Material.IRON_INGOT)).name("&aKit Upgrades").lore("&7Unlock and upgrade your").lore("&7kits.").make(), e -> ShopKitGUI.openGUI(p, true));
        MenuItem advanced = new MenuItem(new ItemBuilder(new ItemStack(Material.GOLD_INGOT)).name("&aAdvanced Kit Upgrades").lore("&7Unlock and upgrade your").lore("&7kits.").make(), e -> ShopKitGUI.openGUI(p, false));
        MenuItem stars = new MenuItem(new ItemBuilder(new ItemStack(Material.NETHER_STAR)).name("&aBlitz Powerups").lore("&7Unlock Blitz powerups to").lore("&7change the gameplay.").make(), e -> ShopStarGUI.openGUI(p));
        ...
        MenuItem taunts = new MenuItem(new ItemBuilder(new ItemStack(Material.MAGMA_CREAM)).name("&aTaunts").lore("&7Unlock and customize the Taunt").lore("&7ability.").make(), e -> TauntGUI.openGUI(p));
        MenuItem auras = new MenuItem(new ItemBuilder(new ItemStack(Material.BLAZE_POWDER)).name("&aAuras").lore("&7Cosmetic particle auras that make you").lore("&7stand out!").make(), e -> AuraGUI.openGUI(p));
