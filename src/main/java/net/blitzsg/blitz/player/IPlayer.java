...
import net.blitzsg.blitz.nametag.Nametag;
import net.blitzsg.blitz.nickname.Nick;
import net.blitzsg.blitz.rank.ranks.Default;
...
public class IPlayer {
    ...
    private boolean robinhood, punched, wobbuffet, blood = true;
