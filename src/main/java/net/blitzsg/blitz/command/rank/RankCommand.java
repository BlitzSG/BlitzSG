package net.blitzsg.blitz.command.rank;

import com.google.common.collect.ImmutableList;

import net.blitzsg.blitz.command.SubCommand;
import net.blitzsg.blitz.command.rank.sub.RankInfoSubCommand;
import net.blitzsg.blitz.command.rank.sub.RankListSubCommand;
import net.blitzsg.blitz.command.rank.sub.RankSetPrefixCommand;
import net.blitzsg.blitz.command.rank.sub.RankSetSubCommand;
